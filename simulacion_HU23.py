...
# ──────────────────────────────────────────────
# HU23 — Simulación y exportación de datos
# ──────────────────────────────────────────────

def generar_vacantes(numeroServicios):
    ...
    for i in range(numeroServicios):
        ...
        # Inyección de errores controlados (proceso estocástico)
        ...
        if probabilidadError < 0.1:
            ...
            vacante["presupuestoSalario"] = str(vacante["presupuestoSalario"]) + random.choice(["f", "r", "t"])
...
def exportar_vacantes(df, nombre_archivo="vacantes_simuladas.csv"):
